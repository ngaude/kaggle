...
with open(ddir+'guessable.txt') as f:
...
test['txt'] = map(normalize_guess,test.Libelle)
...
diff.to_csv('lib_diff.csv',sep=';',index=False)
...
guess.to_csv(ddir+'resultat.lib_guess.csv',sep=';',index=False)
